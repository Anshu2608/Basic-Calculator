...
import 'package:new_calculator/functionality.dart';
...
*/
  ...
  double _performOperation(double num1, double num2, String operand) {
    switch (operand) {
      ...
      default:
        return num2; // Default to returning num2 if no valid operand
    }
  }
  ...
  Widget _buildButton(String buttonText) {
    return Expanded(
      child: TextButton(
        ...
        onPressed: () {
          if (_showAdvanced) {
            // Pass button press to Functionality widget
          } else {
            if (buttonText == "^") {
              _toggleAdvanced();
            } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _showAdvanced ? Functionality(onClose: _toggleAdvanced) : _buildCalculatorButtons(),
    );
  }
